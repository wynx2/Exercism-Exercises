...
def average_even_is_average_odd(hand):
    ...
    """
    add_even = 0
    even_element_count = 0
    add_odd = 0
    odd_element_count = 0
    for each_number in hand[0::2]:
        add_even += each_number
        even_element_count += 1

    for each_number in hand[1::2]:
        add_odd += each_number
        odd_element_count += 1

    return add_even / even_element_count == add_odd / odd_element_count
