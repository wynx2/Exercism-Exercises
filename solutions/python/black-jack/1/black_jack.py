...
def value_of_card(card):
    ...
    card_value_dict = {'J':10,
                       'Q':10,
                       'K':10,
                       'A':1}

    if card in card_value_dict:
...
def is_blackjack(card_one, card_two):
    ...
    current_hand = [value_of_card(card_one), value_of_card(card_two)]

    if 1 in current_hand and 10 in current_hand:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    test_sum = value_of_card(card_one) + value_of_card(card_two)
    if 9 <= test_sum <= 11:
        return True
    return False
