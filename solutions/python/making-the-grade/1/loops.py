...
def letter_grades(highest):
    ...
    compute_interval = (highest - 40) // 4
    grade_threshold = [41]
    for letter_grade in range(3):
        grade_threshold.append(grade_threshold[letter_grade] + compute_interval)
...
def student_ranking(student_scores, student_names):
    ...
    """
    rank = 0
    student_rankings = list()

    for student in student_names:
        rank += 1
        student_rankings.append(f"{rank}. {student}: {student_scores[student_names.index(student)]}")
