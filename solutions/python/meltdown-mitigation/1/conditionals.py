...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    normal_threshold_lower = threshold * .90
    normal_threshold_upper = threshold * 1.10
    reactor_output = temperature * neutrons_produced_per_second
    if reactor_output < normal_threshold_lower:
        return 'LOW'
    elif reactor_output > normal_threshold_upper:
        return 'DANGER'
    return 'NORMAL'
